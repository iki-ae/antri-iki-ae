...
export const sessionsApi = {
  ...
  create:  (data: { category_id: number; title: string; mode: 'bulk' | 'kiosk'; bulk_count?: number }) => api.post<Session>('/sessions/create', data),
  update:  (id: number, data: { title?: string; mode?: 'bulk' | 'kiosk'; bulk_count?: number })         => api.put<Session>(`/sessions/${id}`, data),
