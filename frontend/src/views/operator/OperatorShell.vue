...
const icons = { gridOutline, settingsOutline, personCircleOutline, logOutOutline }
...
const menuItems = [
  { path: '/operator/dashboard', iconKey: 'gridOutline',    label: 'operator.nav.dashboard' },
  { path: '/operator/settings',  iconKey: 'settingsOutline', label: 'operator.nav.settings'  },
] as const
